...
CELEBA_DATE_DIR= 'dataset/img_align_celeba'
...
def discriminator(input_images):
    with tf.variable_scope("Discriminator"):
        ...
        out_1 = batch_norm(out_1,
                           discriminator_variables_dict['beta_1'],
                           discriminator_variables_dict['gamma_1'],
...
def optimizer(loss, d_or_g):
    optim = tf.train.AdamOptimizer(learning_rate=0.01, beta1=0.5)
    ...
    for j in range(num_batch):
        ...
        if step == num_batch-1:
            ...
            for k in range(5):
                ...
                misc.imsave('tmp/img/fake_image' + str(step) + str(k) + '.jpg', image)
