...
print('feature:', sum(feature_nums))

##　img_noise是一张噪声，如果要生成img,需要这个
def deep_dream(obj,
    ...
    for octave in range(octave_n):
        ...
        for _ in range(iter_n):
            ...
            # 保存图像
        output_file = 'tmp/v3_output' + str(octave + 1) + '.jpg'
        cv2.imwrite(output_file, img)
        print(output_file)

input_img = cv2.imread('tmp/kenan.jpg')
...
print(tf.square(graph.get_tensor_by_name("import/%s:0" % layer)))